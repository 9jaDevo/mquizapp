/// Generic wrapper for NestJS API envelope:
...
class ApiResponse<T> {
  ...
  /// Parse the raw JSON map coming from the NestJS API.
  ///
  /// [fromJson] converts the `data` field from `dynamic` to [T].
  /// Pass `(d) => d` if the raw value is already usable.
