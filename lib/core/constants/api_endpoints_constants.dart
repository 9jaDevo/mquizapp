...
const getLeaguesUrl = '$_api/get_leagues';
const optInLeagueUrl = '$_api/opt_in_league';
const joinLeagueUrl = '$_api/join_league';
const getLeagueDailyQuizUrl = '$_api/get_league_daily_quiz';
const submitLeagueQuizUrl = '$_api/submit_league_quiz';
const getLeagueLeaderboardUrl = '$_api/get_league_leaderboard';
