...
<head>
    ...
    <title>All-Time Engagement Leaderboard | <?php echo (is_settings('app_name')) ? is_settings('app_name') : "" ?></title>
...
<body>
            ...
            <div class="main-content">
                <section class="section">
                    <div class="section-header">
                        <h1>All-Time Engagement Leaderboard <small>Overall user engagement rankings</small></h1>
                    </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-3 col-sm-6 col-xs-12" id="country_div" style="display:none;">
                                            ...
                                            <div class="form-group col-md-3 col-sm-6 col-xs-12" id="region_div" style="display:none;">
                                        ...
                                        <table aria-describedby="mydesc" class='table-striped' id='engagement_alltime_table'
                                            data-toggle="table"
                                            data-url="<?= base_url() . 'Table/engagement_alltime' ?>"
                                            ...
                                            data-export-options='{ "fileName": "alltime-engagement-<?= date('d-m-y') ?>" }'
    ...
    <script>
        $(document).ready(function() {
            $('#engagement_alltime_table').bootstrapTable('refresh');
            $('#engagement_alltime_table').show();
