...
<head>
    ...
    <title>Weekly Engagement Leaderboard | <?php echo (is_settings('app_name')) ? is_settings('app_name') : "" ?></title>
            ...
            <div class="main-content">
                <section class="section">
                    <div class="section-header">
                        <h1>Weekly Engagement Leaderboard <small>View week-wise user engagement rankings</small></h1>
                    </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <table aria-describedby="mydesc" class='table-striped' id='engagement_weekly_table'
                                            data-toggle="table"
                                            data-url="<?= base_url() . 'Table/engagement_weekly' ?>"
                                            ...
                                            data-export-options='{ "fileName": "weekly-engagement-<?= date('d-m-y') ?>" }'
