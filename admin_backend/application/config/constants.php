...
define('CATEGORY_IMG_PATH', 'database/images/category/');
define('SUBCATEGORY_IMG_PATH', 'database/images/subcategory/');
define('QUESTION_IMG_PATH', 'database/images/questions/');
define('NOTIFICATION_IMG_PATH', 'database/images/notifications/');
define('CONTEST_IMG_PATH', 'database/images/contest/');
define('CONTEST_QUESTION_IMG_PATH', 'database/images/contest-question/');
define('GUESS_WORD_IMG_PATH', 'database/images/guess-word/');
define('USER_IMG_PATH', 'database/images/profile/');
define('LOGO_IMG_PATH', 'database/images/');
define('BADGE_IMG_PATH', 'database/images/badges/');
define('FUN_LEARN_IMG_PATH', 'database/images/fun-n-learn/');
define('FUN_LEARN_QUESTION_IMG_PATH', 'database/images/fun-n-learn-question/');
define('EXAM_QUESTION_IMG_PATH', 'database/images/exam-question/');
define('MATHS_QUESTION_IMG_PATH', 'database/images/maths-questions/');
define('SLIDER_IMG_PATH', 'database/images/slider/');
define('WEB_SETTINGS_LOGO_PATH', 'database/images/web-settings/');
define('WEB_SETTINGS_LOGO_IMG_ALLOWED_TYPES', 'jpg|png|jpeg|svg');
define('WEB_HOME_SETTINGS_LOGO_PATH', 'database/images/web-home-settings/');
define('APP_LANGUAGE_FILE_PATH', 'database/upload/languages/app/');
define('WEB_LANGUAGE_FILE_PATH', 'database/upload/languages/web/');
define('LANGUAGE_FILE_ALLOWED_TYPES', 'json|JSON');
define('COIN_STORE_IMG_PATH', 'database/images/coin-store/');
define('SPONSOR_BANNER_IMG_PATH', 'database/images/sponsor_banners/');
define('LANGUAGE_PATH', 'application/language/');
define('LANGUAGE_ALLOWED_TYPES', 'PHP|php');
define('MULTIMATCH_QUESTION_IMG_PATH', 'database/images/multimatch-questions/');
define('INSTRACTION_IMG_PATH', 'database/images/instruction/');

//audio path
define('QUESTION_AUDIO_PATH', 'database/images/audio/');
