...
class Dashboard extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->result['day_data'] = $this->db->query("SELECT COUNT(id) AS user_count, DAYOFMONTH(date_registered) AS day_name FROM tbl_users WHERE YEAR(date_registered) = YEAR('" . $this->toDate . "') AND MONTH(date_registered) = MONTH('" . $this->toDate . "') GROUP BY DAYOFMONTH(date_registered)")->result();
        
        // Updated Version to correct Error       $this->result['day_data'] = $this->db->query("SELECT COUNT(id) AS user_count, DAYOFMONTH(date_registered) AS day_name FROM tbl_users WHERE YEAR(date_registered) = YEAR('" . $this->toDate . "') AND MONTH(date_registered) = MONTH('" . $this->toDate . "') GROUP BY DAYOFMONTH(date_registered)")->result();
